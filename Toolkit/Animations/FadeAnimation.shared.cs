...
namespace Xamarin.Forms.Toolkit.Animations
{
    ...
    public class FadeInAnimation : AnimationBase
    {
        ...
        internal Animation FadeIn()
        {
            ...
            animation.WithConcurrent((f) => Target.TranslationY = f, Target.TranslationY + ((Direction == FadeDirection.Up) ? 50 : -50), Target.TranslationY, Xamarin.Forms.Easing.CubicOut, 0, 1);
